            ...
            <div className="bg-white p-8 rounded-[20px] border border-gray-100/80">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
                {[
                  ...
                  auto.consumCombinat && ['Consum combinat', `${auto.consumCombinat} l/100km`],
                  auto.consumOras && ['Consum oraș', `${auto.consumOras} l/100km`],
                  auto.consumAutostrada && ['Consum autostradă', `${auto.consumAutostrada} l/100km`],
                  auto.clasaEmisie && ['Clasa de emisie', auto.clasaEmisie],
                  auto.clasaCO2 && ['Clasa CO2', auto.clasaCO2],
                  auto.insignaEcologica && ['Insignă ecologică', auto.insignaEcologica],
