...
export const metadata: Metadata = {
  title: 'Sobre Nosotros - Vindu24 2026',
  description: 'Descubre Vindu24, la plataforma inmobiliaria más innovadora del 2026 con tecnología IA avanzada para revolucionar el sector.',
};
...
const timeline = [
  { year: '2026', title: 'Fundación', description: 'Vindu24 nace como la plataforma inmobiliaria más innovadora del 2026, revolucionando el sector con tecnología de vanguardia.' },
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-8">
              ...
              <p className="text-slate-600 text-lg leading-relaxed mb-6">
                Fundada en 2026, Vindu24 llega como la plataforma inmobiliaria más innovadora del año, revolucionando el sector con tecnología de vanguardia y una experiencia completamente digital. Nuestra visión es transformar completamente cómo se compran y venden propiedades en España.
              </p>
