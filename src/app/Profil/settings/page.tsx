              ...
              return filtered.map(c => {
                ...
                return (
                  <button key={c} type="button"
                    ...
                    className={`w-full text-left px-5 py-3 text-[14px] hover:bg-orange-50 transition-colors flex items-center gap-3 ${value === c ? 'bg-orange-50 text-[#f25c1a]' : 'text-gray-700'
                      }`}>
